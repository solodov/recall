...
- status: implementing
- currentPhase: 4
- currentPhaseTitle: Migrate every in-repo provider and provider-facing binary
- nextPhase: 5
- nextPhaseTitle: Define the external provider boundary in docs only
- totalPhases: 7
- updated: 2026-05-01
...
### [20260428-131631-federated-recall-cli-protobuf-searchprovider](./20260428-131631-federated-recall-cli-protobuf-searchprovider.md)
